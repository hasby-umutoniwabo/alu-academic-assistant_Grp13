...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final presentCount =
        recordedSessions.where((s) => s.isPresent == true).length;
    final absentCount =
        recordedSessions.where((s) => s.isPresent == false).length;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildStatsRow(attendancePercent, pendingCount,
              ...
              child: Center(
                child: Text(
                  ...
                  style: const TextStyle(
                      color: ALUColors.lightGrey, fontSize: 13),
                ),
              ),
            ),
        ],
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(
                      fontSize: 14, color: ALUColors.lightGrey),
                ),
              ],
            ),
            Container(
              ...
              child: Text('Week $weekNumber',
                  style: const TextStyle(
                      color: ALUColors.navy, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ),
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              '(below 75% threshold)',
              style: const TextStyle(
                  color: ALUColors.white, fontWeight: FontWeight.bold),
            ),
          ),
        ],
      ),
  ...
  Widget _buildStatsRow(double attendance, int pending, int upcoming) {
    return Row(
      children: [
        ...
        Expanded(
            child: _buildStatCard('Pending', '$pending', ALUColors.gold,
                Icons.assignment_outlined)),
        const SizedBox(width: 8),
        Expanded(
            child: _buildStatCard(
                'Due Soon', '$upcoming', Colors.orange, Icons.schedule)),
      ],
    );
  }
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(session.title,
            style: const TextStyle(
                fontWeight: FontWeight.bold, color: ALUColors.white)),
        subtitle: Text(
    ...
    return Card(
      ...
      child: ListTile(
        leading: CircleAvatar(
          backgroundColor:
              _getPriorityColor(assignment.priority).withAlpha(50),
          child: Text(assignment.priority[0],
              style: TextStyle(
  ...
  Widget _buildAttendanceHistoryTile(Session session) {
    ...
    final dateStr =
        '${monthNames[session.date.month - 1]} ${session.date.day}';
      ...
      child: ListTile(
        ...
        leading: Column(
          ...
          children: [
            Text(dateStr,
                style: const TextStyle(
                    color: ALUColors.lightGrey, fontSize: 12)),
          ],
        ),
        // Session name
        title: Text(session.title,
