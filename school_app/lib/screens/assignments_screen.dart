      ...
      body: sortedAssignments.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildAssignmentCard(context, sortedAssignments[index]);
              },
            ),
  ...
  Widget _buildEmptyState() {
    return const Center(
      child: Column(
        ...
        children: [
          Icon(Icons.assignment_outlined, size: 64, color: ALUColors.lightGrey),
          SizedBox(height: 16),
          Text(
            'No assignments yet',
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    final isDuplicate = assignments.any(
                      (a) =>
                          a.title.toLowerCase() ==
